...
<body>
	...
	<div class="row justify-content-md-center">
		...
		<div class="col-12 col-md-auto">
			...
			<div class="row">
				...
				<div class="col-12">
					<a style="width: 12rem; height: 2.4rem" href="#"><b>View Submitted Summary</b></a>
					<div class="btn-group" role="group" aria-label="Basic example">
						<a href="addSummaryQuestion.jsp" class="btn btn-outline-primary" style="width: 12rem; height: 2.4rem"
							><b>Add New Question</b></a>	
					</div>
				</div>
	...
	<script>
	function popupAddQuestionForm(){
		window.open("addSummaryQuestion.jsp", "", "width=820,height=180");
	}
